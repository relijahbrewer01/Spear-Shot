...
def main() -> int:
    ...
    require("_restore_close_hit_stop_async" in main_script, "Main restores hit stop through an asynchronous real-time timer", failures)
    ...
    require("create_timer(close_hit_stop_duration, true, false, true)" in main_script, "Hit-stop restore timer ignores time scale", failures)
