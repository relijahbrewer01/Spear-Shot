...
const TEXTURE_PATHS := [
	...
	"res://art/sprites/prowler_enemy.png",
	"res://art/sprites/prowler_enemy_sheet.png",
...
const AUDIO_PATHS := [
	...
	"res://audio/charger_charge.wav",
	"res://audio/charger_dash.wav",
	"res://audio/spear_recover.wav",
...
const SCENE_SPRITES := {
	...
	"res://ProwlerEnemy.tscn": "Sprite2D",
...
func _audit_main_scene_audio(report_lines: Array[String]) -> int:
	...
	for player_path in [
		...
		"AudioPlayers/ChargerChargePlayer",
		"AudioPlayers/ChargerDashPlayer",
